 ...
 */
@JsonPropertyOrder({
  Buyer.JSON_PROPERTY_EXTERNAL_USER_TYPE,
  Buyer.JSON_PROPERTY_NICKNAME,
  Buyer.JSON_PROPERTY_EXTERNAL_USER_ID,
  Buyer.JSON_PROPERTY_USER_ID
})
...
public class Buyer {
  ...
  public Buyer externalUserType(@javax.annotation.Nullable String externalUserType) {
  ...
  public Buyer nickname(@javax.annotation.Nullable String nickname) {
  ...
  public Buyer externalUserId(@javax.annotation.Nullable String externalUserId) {
  ...
  public Buyer userId(@javax.annotation.Nullable String userId) {
  ...
  public boolean equals(Object o) {
    ...
    Buyer buyer = (Buyer) o;
    return Objects.equals(this.externalUserType, buyer.externalUserType) &&
        Objects.equals(this.nickname, buyer.nickname) &&
        Objects.equals(this.externalUserId, buyer.externalUserId) &&
        Objects.equals(this.userId, buyer.userId);
  }
