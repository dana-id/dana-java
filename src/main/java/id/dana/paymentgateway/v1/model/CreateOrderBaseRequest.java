 ...
 */
@JsonPropertyOrder({
  CreateOrderBaseRequest.JSON_PROPERTY_PARTNER_REFERENCE_NO,
  CreateOrderBaseRequest.JSON_PROPERTY_MERCHANT_ID,
  CreateOrderBaseRequest.JSON_PROPERTY_SUB_MERCHANT_ID,
  CreateOrderBaseRequest.JSON_PROPERTY_AMOUNT,
  CreateOrderBaseRequest.JSON_PROPERTY_EXTERNAL_STORE_ID,
  CreateOrderBaseRequest.JSON_PROPERTY_VALID_UP_TO,
  CreateOrderBaseRequest.JSON_PROPERTY_DISABLED_PAY_METHODS,
  CreateOrderBaseRequest.JSON_PROPERTY_URL_PARAMS
})
...
public class CreateOrderBaseRequest {
  ...
  public CreateOrderBaseRequest() {
  }

  public CreateOrderBaseRequest partnerReferenceNo(@javax.annotation.Nonnull String partnerReferenceNo) {
  ...
  public CreateOrderBaseRequest merchantId(@javax.annotation.Nonnull String merchantId) {
  ...
  public CreateOrderBaseRequest subMerchantId(@javax.annotation.Nullable String subMerchantId) {
  ...
  public CreateOrderBaseRequest amount(@javax.annotation.Nonnull Money amount) {
  ...
  public CreateOrderBaseRequest externalStoreId(@javax.annotation.Nullable String externalStoreId) {
  ...
  public CreateOrderBaseRequest validUpTo(@javax.annotation.Nullable String validUpTo) {
  ...
  public CreateOrderBaseRequest disabledPayMethods(@javax.annotation.Nullable String disabledPayMethods) {
  ...
  public CreateOrderBaseRequest urlParams(@javax.annotation.Nonnull List<UrlParam> urlParams) {
    
    this.urlParams = urlParams;
    return this;
  }

  public CreateOrderBaseRequest addUrlParamsItem(UrlParam urlParamsItem) {
  ...
  public boolean equals(Object o) {
    ...
    CreateOrderBaseRequest createOrderBaseRequest = (CreateOrderBaseRequest) o;
    return Objects.equals(this.partnerReferenceNo, createOrderBaseRequest.partnerReferenceNo) &&
        Objects.equals(this.merchantId, createOrderBaseRequest.merchantId) &&
        Objects.equals(this.subMerchantId, createOrderBaseRequest.subMerchantId) &&
        Objects.equals(this.amount, createOrderBaseRequest.amount) &&
        Objects.equals(this.externalStoreId, createOrderBaseRequest.externalStoreId) &&
        Objects.equals(this.validUpTo, createOrderBaseRequest.validUpTo) &&
        Objects.equals(this.disabledPayMethods, createOrderBaseRequest.disabledPayMethods) &&
        Objects.equals(this.urlParams, createOrderBaseRequest.urlParams);
  }

  @Override
  public int hashCode() {
    return Objects.hash(partnerReferenceNo, merchantId, subMerchantId, amount, externalStoreId, validUpTo, disabledPayMethods, urlParams);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateOrderBaseRequest {\n");
