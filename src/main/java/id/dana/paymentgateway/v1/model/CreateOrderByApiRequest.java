 ...
 */
@JsonPropertyOrder({
  CreateOrderByApiRequest.JSON_PROPERTY_PAY_OPTION_DETAILS,
  CreateOrderByApiRequest.JSON_PROPERTY_ADDITIONAL_INFO,
  CreateOrderByApiRequest.JSON_PROPERTY_PARTNER_REFERENCE_NO,
  CreateOrderByApiRequest.JSON_PROPERTY_MERCHANT_ID,
  CreateOrderByApiRequest.JSON_PROPERTY_SUB_MERCHANT_ID,
  CreateOrderByApiRequest.JSON_PROPERTY_AMOUNT,
  CreateOrderByApiRequest.JSON_PROPERTY_EXTERNAL_STORE_ID,
  CreateOrderByApiRequest.JSON_PROPERTY_VALID_UP_TO,
  CreateOrderByApiRequest.JSON_PROPERTY_DISABLED_PAY_METHODS,
  CreateOrderByApiRequest.JSON_PROPERTY_URL_PARAMS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class CreateOrderByApiRequest implements CreateOrderRequest {
  ...
  private CreateOrderByApiAdditionalInfo additionalInfo;
  ...
  public CreateOrderByApiRequest() {
  }

  public CreateOrderByApiRequest payOptionDetails(@javax.annotation.Nonnull List<PayOptionDetail> payOptionDetails) {
    
    this.payOptionDetails = payOptionDetails;
    return this;
  }

  public CreateOrderByApiRequest addPayOptionDetailsItem(PayOptionDetail payOptionDetailsItem) {
  ...
  @JsonProperty(JSON_PROPERTY_PAY_OPTION_DETAILS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPayOptionDetails(@javax.annotation.Nonnull List<PayOptionDetail> payOptionDetails) {
    this.payOptionDetails = payOptionDetails;
  }

  public CreateOrderByApiRequest additionalInfo(@javax.annotation.Nullable CreateOrderByApiAdditionalInfo additionalInfo) {
  ...
  public CreateOrderByApiAdditionalInfo getAdditionalInfo() {
    return additionalInfo;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ADDITIONAL_INFO)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAdditionalInfo(@javax.annotation.Nullable CreateOrderByApiAdditionalInfo additionalInfo) {
    this.additionalInfo = additionalInfo;
  }

  public CreateOrderByApiRequest partnerReferenceNo(@javax.annotation.Nonnull String partnerReferenceNo) {
  ...
  public CreateOrderByApiRequest merchantId(@javax.annotation.Nonnull String merchantId) {
  ...
  public CreateOrderByApiRequest subMerchantId(@javax.annotation.Nullable String subMerchantId) {
  ...
  public CreateOrderByApiRequest amount(@javax.annotation.Nonnull Money amount) {
  ...
  public CreateOrderByApiRequest externalStoreId(@javax.annotation.Nullable String externalStoreId) {
  ...
  public CreateOrderByApiRequest validUpTo(@javax.annotation.Nullable String validUpTo) {
  ...
  public CreateOrderByApiRequest disabledPayMethods(@javax.annotation.Nullable String disabledPayMethods) {
  ...
  public CreateOrderByApiRequest urlParams(@javax.annotation.Nonnull List<UrlParam> urlParams) {
    
    this.urlParams = urlParams;
    return this;
  }

  public CreateOrderByApiRequest addUrlParamsItem(UrlParam urlParamsItem) {
  ...
  public boolean equals(Object o) {
    ...
    CreateOrderByApiRequest createOrderByApiRequest = (CreateOrderByApiRequest) o;
    return Objects.equals(this.payOptionDetails, createOrderByApiRequest.payOptionDetails) &&
        Objects.equals(this.additionalInfo, createOrderByApiRequest.additionalInfo) &&
        Objects.equals(this.partnerReferenceNo, createOrderByApiRequest.partnerReferenceNo) &&
        Objects.equals(this.merchantId, createOrderByApiRequest.merchantId) &&
        Objects.equals(this.subMerchantId, createOrderByApiRequest.subMerchantId) &&
        Objects.equals(this.amount, createOrderByApiRequest.amount) &&
        Objects.equals(this.externalStoreId, createOrderByApiRequest.externalStoreId) &&
        Objects.equals(this.validUpTo, createOrderByApiRequest.validUpTo) &&
        Objects.equals(this.disabledPayMethods, createOrderByApiRequest.disabledPayMethods) &&
        Objects.equals(this.urlParams, createOrderByApiRequest.urlParams);
  }

  @Override
  public int hashCode() {
    return Objects.hash(payOptionDetails, additionalInfo, partnerReferenceNo, merchantId, subMerchantId, amount, externalStoreId, validUpTo, disabledPayMethods, urlParams);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateOrderByApiRequest {\n");
