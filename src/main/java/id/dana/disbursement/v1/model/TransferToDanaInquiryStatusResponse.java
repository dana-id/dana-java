 ...
 */
@JsonPropertyOrder({
  TransferToDanaInquiryStatusResponse.JSON_PROPERTY_RESPONSE_CODE,
  TransferToDanaInquiryStatusResponse.JSON_PROPERTY_RESPONSE_MESSAGE,
  TransferToDanaInquiryStatusResponse.JSON_PROPERTY_ORIGINAL_PARTNER_REFERENCE_NO,
  TransferToDanaInquiryStatusResponse.JSON_PROPERTY_ORIGINAL_REFERENCE_NO,
  TransferToDanaInquiryStatusResponse.JSON_PROPERTY_ORIGINAL_EXTERNAL_ID,
  TransferToDanaInquiryStatusResponse.JSON_PROPERTY_SERVICE_CODE,
  TransferToDanaInquiryStatusResponse.JSON_PROPERTY_AMOUNT,
  TransferToDanaInquiryStatusResponse.JSON_PROPERTY_LATEST_TRANSACTION_STATUS,
  TransferToDanaInquiryStatusResponse.JSON_PROPERTY_TRANSACTION_STATUS_DESC,
  TransferToDanaInquiryStatusResponse.JSON_PROPERTY_ADDITIONAL_INFO
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class TransferToDanaInquiryStatusResponse {
  ...
  public TransferToDanaInquiryStatusResponse() {
  }

  public TransferToDanaInquiryStatusResponse responseCode(@javax.annotation.Nonnull String responseCode) {
  ...
  public TransferToDanaInquiryStatusResponse responseMessage(@javax.annotation.Nonnull String responseMessage) {
  ...
  public TransferToDanaInquiryStatusResponse originalPartnerReferenceNo(@javax.annotation.Nonnull String originalPartnerReferenceNo) {
  ...
  public TransferToDanaInquiryStatusResponse originalReferenceNo(@javax.annotation.Nullable String originalReferenceNo) {
  ...
  public TransferToDanaInquiryStatusResponse originalExternalId(@javax.annotation.Nullable String originalExternalId) {
  ...
  public TransferToDanaInquiryStatusResponse serviceCode(@javax.annotation.Nonnull String serviceCode) {
  ...
  public TransferToDanaInquiryStatusResponse amount(@javax.annotation.Nonnull Money amount) {
  ...
  public TransferToDanaInquiryStatusResponse latestTransactionStatus(@javax.annotation.Nonnull LatestTransactionStatusEnum latestTransactionStatus) {
  ...
  public TransferToDanaInquiryStatusResponse transactionStatusDesc(@javax.annotation.Nonnull String transactionStatusDesc) {
  ...
  @JsonProperty(JSON_PROPERTY_TRANSACTION_STATUS_DESC)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTransactionStatusDesc(@javax.annotation.Nonnull String transactionStatusDesc) {
    this.transactionStatusDesc = transactionStatusDesc;
  }

  public TransferToDanaInquiryStatusResponse additionalInfo(@javax.annotation.Nullable Object additionalInfo) {
  ...
  public boolean equals(Object o) {
    ...
    TransferToDanaInquiryStatusResponse transferToDanaInquiryStatusResponse = (TransferToDanaInquiryStatusResponse) o;
    return Objects.equals(this.responseCode, transferToDanaInquiryStatusResponse.responseCode) &&
        Objects.equals(this.responseMessage, transferToDanaInquiryStatusResponse.responseMessage) &&
        Objects.equals(this.originalPartnerReferenceNo, transferToDanaInquiryStatusResponse.originalPartnerReferenceNo) &&
        Objects.equals(this.originalReferenceNo, transferToDanaInquiryStatusResponse.originalReferenceNo) &&
        Objects.equals(this.originalExternalId, transferToDanaInquiryStatusResponse.originalExternalId) &&
        Objects.equals(this.serviceCode, transferToDanaInquiryStatusResponse.serviceCode) &&
        Objects.equals(this.amount, transferToDanaInquiryStatusResponse.amount) &&
        Objects.equals(this.latestTransactionStatus, transferToDanaInquiryStatusResponse.latestTransactionStatus) &&
        Objects.equals(this.transactionStatusDesc, transferToDanaInquiryStatusResponse.transactionStatusDesc) &&
        Objects.equals(this.additionalInfo, transferToDanaInquiryStatusResponse.additionalInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransferToDanaInquiryStatusResponse {\n");
