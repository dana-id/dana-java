...
public class PayOptionInfo {
  ...
  public enum PayOptionEnum {
    ...
    /**
     * Payment method with Paylater Indodana
     */
    NETWORK_PAY_PL_INDODANA(String.valueOf("NETWORK_PAY_PL_INDODANA")),
    ...
    VIRTUAL_ACCOUNT_BSI_PAYMENT(String.valueOf("VIRTUAL_ACCOUNT_BSI_PAYMENT")),
