...
### Usage Example
```java
import id.dana.paymentgateway.v1.model.ConsultPayPaymentInfo.PayMethodEnum;
...
| `NETWORK_PAY_PC_INDOMARET` | "NETWORK_PAY_PC_INDOMARET" | Payment method with Indomaret |
| `NETWORK_PAY_PG_QRIS` | "NETWORK_PAY_PG_QRIS" | Payment method with QRIS |
| `NETWORK_PAY_PL_INDODANA` | "NETWORK_PAY_PL_INDODANA" | Payment method with Paylater Indodana |
...
| `VIRTUAL_ACCOUNT_BSI_PAYMENT` | "VIRTUAL_ACCOUNT_BSI_PAYMENT" | Payment method with BRI virtual account |
| `VIRTUAL_ACCOUNT_BRI` | "VIRTUAL_ACCOUNT_BRI" | Payment method with BTPN virtual account |
| `VIRTUAL_ACCOUNT_BTPN` | "VIRTUAL_ACCOUNT_BTPN" | Payment method with CIMB virtual account |
| `VIRTUAL_ACCOUNT_CIMB` | "VIRTUAL_ACCOUNT_CIMB" | Payment method with Permata virtual account |
| `VIRTUAL_ACCOUNT_PERMATA` | "VIRTUAL_ACCOUNT_PERMATA" | Payment method with Panin virtual account |
| `VIRTUAL_ACCOUNT_PANI` | "VIRTUAL_ACCOUNT_PANI" |  |

### Usage Example
```java
import id.dana.paymentgateway.v1.model.ConsultPayPaymentInfo.PayOptionEnum;
